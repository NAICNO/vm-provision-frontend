...
const HelpSSHPage = () => {
  const responsiveStyles = {
    ...
    h2Size: {base: 'md', md: 'md'} as const,
    h3Size: {base: 'sm', md: 'sm'} as const,
  ...
  return (
    <Box maxW="800px" px={responsiveStyles.paddingX} py={5} alignItems={'start'}>
      ...
      <List.Root as="ul" pl={5} fontSize={responsiveStyles.textSize} mb={responsiveStyles.marginY} gap={2}>
        <List.Item>
      ...
      <Heading as="h2" size={responsiveStyles.h2Size} mt={8} mb={responsiveStyles.marginY}>
      ...
      <List.Root as="ul" pl={5} fontSize={responsiveStyles.textSize} mb={responsiveStyles.marginY} gap={2}>
        ...
        <List.Item>
          ...
          <List.Root as="ul" pl={10} gap={2} pt={2}>
            <List.Item>
      ...
      <Heading as="h3" size={responsiveStyles.h2Size} mt={8} mb={responsiveStyles.marginY}>
        4. Common Issues and How to Resolve Them
      </Heading>
      <Heading as="h4" size={responsiveStyles.h3Size}>A. Connection Refused</Heading>
      <Heading as="h5" size={responsiveStyles.h3Size} pt={2}>Symptoms:</Heading>
      ...
      <Heading as="h5" size={responsiveStyles.h3Size}>Possible Causes & Solutions:</Heading>
      ...
      <Heading as="h4" mt={8} size={responsiveStyles.h3Size}>B. Permission Denied (Publickey)</Heading>
      <Heading as="h5" size={responsiveStyles.h3Size} pt={2}>Symptoms:</Heading>
      <List.Root as={'ul'} pt={2} pb={4}>
        <List.Item>
          <Text>Error message: </Text>
      ...
      <Heading as="h4" mt={8} size={responsiveStyles.h3Size}>C. Timeout or No Route to Host</Heading>
      <Heading as="h5" size={responsiveStyles.h3Size} pt={2}>Symptoms:</Heading>
      <List.Root as='ul' pt={2} pb={4}>
        <List.Item>
          <Text>Error message: </Text>
      ...
      <Heading as="h4" mt={8} size={responsiveStyles.h3Size}>D. Host Key Verification Failed</Heading>
      <Heading as="h5" size={responsiveStyles.h3Size} pt={2}>Symptoms:</Heading>
      <List.Root as={'ul'} pt={2} pb={4}>
        <List.Item>
          <Text>Error message: </Text>
      ...
      <Heading as="h5" size={responsiveStyles.h3Size}>What It Means:</Heading>
      <Text pt={2} pb={4}>
